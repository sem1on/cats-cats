...
const CatsItem = ({ cat, favorit, onAddToFavorite, onDeletCat }) => {

    const catIdFav = favorit.map(item => (item.id))
    ...
    return (
        ...
        <div className='cats-item'>
            <img src={cat.url} alt="cat" />
                ...
                {!catIdFav.includes(cat.id)
                    ?
                    <div className='hearts' onClick={onAddToFavorite} >
                        <div className='heart' >
